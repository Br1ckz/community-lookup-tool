...
import communitylookuptool.Event;
...
public class TestEvent {
    ...
    @BeforeEach
    public void setUp() {
        event = new Event("IST Meeting", "1/25/2022", "3:00PM");
    }
    ...
    @Test
    void testToString() {
        assertEquals("Event{name=IST Meeting, date=1/25/2022, time=3:00PM}", event.toString());
    }
}